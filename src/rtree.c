...
rtree_node_alloc_t *const rtree_node_alloc = rtree_node_alloc_impl;
...
rtree_node_dalloc_t *const rtree_node_dalloc =
...
rtree_leaf_alloc_t *const rtree_leaf_alloc = rtree_leaf_alloc_impl;
...
rtree_leaf_dalloc_t *const rtree_leaf_dalloc =
