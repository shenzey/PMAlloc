#ifndef PMALLOC_INTERNAL_ATOMIC_GCC_ATOMIC_H
#define PMALLOC_INTERNAL_ATOMIC_GCC_ATOMIC_H
...
#define PMALLOC_GENERATE_ATOMICS(type, short_type,			\
    /* unused */ lg_size)						\
typedef struct {							\
	type repr;							\
...
#define PMALLOC_GENERATE_INT_ATOMICS(type, short_type,			\
    /* unused */ lg_size)						\
PMALLOC_GENERATE_ATOMICS(type, short_type, /* unused */ lg_size)	\
									\
ATOMIC_INLINE type							\
...
#endif /* PMALLOC_INTERNAL_ATOMIC_GCC_ATOMIC_H */
